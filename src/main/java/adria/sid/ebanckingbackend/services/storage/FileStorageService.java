...
import adria.sid.ebanckingbackend.exceptions.MyFileNotFoundException;
...
public class FileStorageService {
    ...
    public void storeFile(byte[] content, String fileName) {
        try {
    ...
    public String storeFile(MultipartFile file) {
        ...
        try {
            ...
            storeFile(content, targetLocation.getFileName().toString());
